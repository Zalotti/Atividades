...
<td><div style="text-align:right" style="font-family:'Courier New'">
    <div class="vertical-menu">
            ...
            <tr>
                <td contenteditable='true'><%=a.getTitle()%></td>
                <td contenteditable='true'><%=a.getDescription()%></td>
                <td contenteditable='true'><%=a.getStatus()%></td>
                <td contenteditable='true'><%=a.getCreation_date()%></td>
                <td contenteditable='true'><%=a.getFinished_date()%></td>
            </tr>
            <%} %>
            </table>
            <br>
